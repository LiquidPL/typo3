...
class TcaSelectGroupUsersAjaxFieldData implements FormDataGroupInterface
{
    /**
    ...
    public function compile(array $result)
    {
        ...
        $orderedProviderList->setProviderList(
            $GLOBALS['TYPO3_CONF_VARS']['SYS']['formEngine']['formDataGroup']['tcaSelectGroupUsersAjaxFieldData']
        );
